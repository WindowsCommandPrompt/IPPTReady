...
public class CycleActivity extends AppCompatActivity {
    ...
    private FirebaseViewItem<IPPTCycle> notFinishedCycle = null;
                                ...
                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        if (!querySnapshot.isEmpty()) {
                                            ArrayList<FirebaseViewItem<IPPTCycle>> finishedCycles = new ArrayList<>();
                                            ...
                                            setRecycleViewContent(new ArrayList<>());
                                            setCreateCycleButton();
                                        }
                                    }
                                    else {
    ...
    private void setCompleteCycleButton() {
        ...
        if (null != notFinishedCycle)
            findViewById(R.id.constraintLayout2).setOnClickListener(new RoutineOnClickListener(this, notFinishedCycle));
    }
    ...
    private class CycleActivityResultContract extends ActivityResultContract<Date, FirebaseDoc<IPPTCycle>> {
        ...
        public Intent createIntent(@NonNull Context context, @NonNull Date dateCreated) {
            ...
            intent.putExtra("userId", EmailAddress);
